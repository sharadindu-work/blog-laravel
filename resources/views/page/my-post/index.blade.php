                    ...
                    <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        <div class="flex justify-between items-center mb-5 text-gray-500">
                          <span class="bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                            ...
                            <a href="{{route('user.my-post.edit',$value->id)}}" class="text-blue-700 border border-blue-700 hover:bg-blue-700 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800 dark:hover:bg-blue-500 mr-2">
                                <i class="fa-solid fa-pen"></i>
                                <span class="sr-only">Icon description</span>
                            </a>
                                <form method="POST" action="{{ route('user.my-post.destroy', $value->id) }}">
                                  @csrf
                        ...
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400 line-clamp-4">{{$value->content}}</p>
                        <div class="flex justify-between items-center">
                          ...
                          {{$value->user->name}}
                            ...
                            <a href="{{route('post.details',$value->id)}}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                                Read more
